  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-around p-24">
      ...
      <div className="relative flex text-5xl place-items-center ">
        <h2 class="my-6 text-4xl font-extrabold bg-gradient-to-r from-gray-700 via-gray-900 to-gray-800 bg-clip-text text-transparent sm:text-5xl sm:tracking-tight lg:text-6xl text-center">A Blockchain Based Mobile Phone Tracking System and Theft Prevention</h2>
      </div>
